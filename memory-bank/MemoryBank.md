...
-   ThemeToggle component with client-side state management
-   Theme-aware custom utility classes (.btn-primary, .card, etc.)
-   Component-specific styles organized in global CSS
